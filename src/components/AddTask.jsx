...
const AddTask = ({ employees, onAddTask }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const maxId = allTasks.length > 0 ? Math.max(...allTasks.map(t => t.id)) : 100;
    const newTask = {
      id: maxId + 1,
    ...
    onAddTask(parseInt(formData.employeeId), newTask);
